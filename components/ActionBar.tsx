...
const ActionBar: React.FC<ActionBarProps> = ({
  ...
  const qualityDescriptions: Record<QualityLevel, string> = {
    [QualityLevel.MAX]: 'Original DPI + structural optimization',
    [QualityLevel.HIGH]: 'Sharp quality + object stream compression',
    [QualityLevel.STANDARD]: 'Web-balanced size & performance',
    [QualityLevel.COMPRESSED]: 'Smallest size for email/mobile'
  };
      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-6">
        ...
        <div className="flex flex-wrap items-center gap-6 bg-slate-50/80 p-1.5 rounded-2xl border border-slate-100">
          <div className="flex flex-col px-3">
            <label className="text-[10px] font-black text-slate-400 uppercase mb-0.5 ml-1">Export Mode</label>
